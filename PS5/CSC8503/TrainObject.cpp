...
void TrainObject::InitPaths(int level) {
    switch (level) {
    case 1:
        firstPath = Vector3(50, 3.5f, 100);
        finalPath = Vector3(70, 3.5f, 100);
        finishPath = Vector3(80, 3.5f, 100);
        path.push_back(firstPath);
        break;
    case 2:
        firstPath = Vector3(50, 3.5f, 50);
        finalPath = Vector3(70, 3.5f, 50);
        finishPath = Vector3(80, 3.5f, 50);
        path.push_back(firstPath);
        break;
    case 3:
        firstPath = Vector3(50, 3.5f, 20);
        finalPath = Vector3(70, 3.5f, 20);
        finishPath = Vector3(80, 3.5f, 20);
        path.push_back(firstPath);
        break;
    //case 4:
